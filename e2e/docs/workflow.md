...
This is the operational reference for `e2e/`. Read the section needed for setup, scenario authoring, or failure diagnosis. Repository paths and commands are relative to the repository root unless stated otherwise. Core task boundaries live in `../AGENTS.md`.
